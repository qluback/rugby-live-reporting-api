 ...
 */
final class Version20241120173824 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE game ADD COLUMN status INTEGER NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TEMPORARY TABLE __temp__game AS SELECT id, team_competing_home_id, team_competing_visitor_id, score_home, score_visitor, time, half_time FROM game');
        $this->addSql('DROP TABLE game');
        $this->addSql('CREATE TABLE game (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, team_competing_home_id INTEGER NOT NULL, team_competing_visitor_id INTEGER NOT NULL, score_home INTEGER NOT NULL, score_visitor INTEGER NOT NULL, time INTEGER NOT NULL, half_time INTEGER NOT NULL, CONSTRAINT FK_232B318C97384821 FOREIGN KEY (team_competing_home_id) REFERENCES team_competing (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_232B318C3CD91D49 FOREIGN KEY (team_competing_visitor_id) REFERENCES team_competing (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO game (id, team_competing_home_id, team_competing_visitor_id, score_home, score_visitor, time, half_time) SELECT id, team_competing_home_id, team_competing_visitor_id, score_home, score_visitor, time, half_time FROM __temp__game');
